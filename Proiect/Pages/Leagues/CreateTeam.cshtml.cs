		...
		public void OnPost()
		{
			...
			try
			{
				...
				using (SqlConnection connection = new SqlConnection(connectionString))
				{
					...
					sql = "SET IDENTITY_INSERT [teams] ON INSERT INTO teams " + "(id, name,teamValue, squadSize, stadium, city, idLeague) VALUES " + "(@id, @name,@teamValue, @squadSize, @stadium, @city, @idLeague)";
